    ...
    fun spec(): CommandSpec {
        ...
        return CommandSpec
            ...
            .executor(simple { src, ctx ->
                ...
                Scripts.triggerStorage.add(script.id, TriggerType.CLICK( vec ))
                src.sendMessage(Text.of(TextColors.GREEN, "Added ClickTrigger to ", TextColors.YELLOW, block.type, "@", vec))
